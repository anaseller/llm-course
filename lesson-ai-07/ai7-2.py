...
def main():
    ...
    prompts = [
        "A serene landscape with mountains and a lake at sunset",  # Пейзаж с горами и озером на закате
        "A futuristic city with flying cars and neon lights",  # Футуристический город с летающими машинами
    ]
